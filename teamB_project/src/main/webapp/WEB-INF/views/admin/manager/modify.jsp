              ...
              <section class="panel">
                ...
                <div class="panel-body">
                  <form class="form-horizontal bucket-form" method="post">
                    ...
                    <div class="center">
                      <button class="btn btn-primary btn-sm" onClick="location.href='/admin/manager/detail'"><i class="fa fa-check"></i> 완료</button>
                      <button class="btn btn-sm" onClick="location.href='/admin/manager/detail'"><i class="fa fa-times"></i> 취소</button>
                    </div>
                    </form>
                </div>
              </section>
