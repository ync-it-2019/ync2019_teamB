              ...
              <section class="panel">
                ...
                <div class="panel-body">
                  <div class="compose-mail">
                      ...
                      <div class="center">
                        <button class="btn btn-primary btn-sm" onClick="location.href='./event_modify.html'">수정</button>
                        <button class="btn btn-sm" onClick="location.href='./event_list.html'">삭제</button>
                      </div>
