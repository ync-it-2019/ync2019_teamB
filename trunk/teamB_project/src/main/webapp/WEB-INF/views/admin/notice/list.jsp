                ...
                <div class="panel-body minimal">
                  <div class="table-inbox-wrap ">
                    <table class="table table-inbox table-hover" style="table-layout: fixed">
                      <tbody>
                        ...
                        <tr class="unread">
                          ...
                          <td class="inbox-small-cells text_limit" onClick="location.href='./notice_detail.html'">운영자_a</td>
                          <td class="view-message dont-show text_limit" onClick="location.href='./notice_detail.html'">행복한 소모임인, 즐거운 소모임 되기!</td>
                          <td class="view-message inbox-small-cells text_limit" onClick="location.href='./notice_detail.html'">2019-10-28</td>
                          <td class="view-message text-right" onClick="location.href='./notice_detail.html'">ON</td>
                        </tr>
                        <tr class="unread">
                          <td class="inbox-small-cells">
                            <input type="checkbox" class="mail-checkbox">
                          ...
                          <td class="inbox-small-cells text_limit" onClick="location.href='./notice_detail.html'"></td>
                          <td class="view-message dont-show text_limit" onClick="location.href='./notice_detail.html'"></td>
                          <td class="view-message inbox-small-cells text_limit" onClick="location.href='./notice_detail.html'"></td>
                          <td class="view-message text-right" onClick="location.href='./notice_detail.html'"></td>
                        </tr>
                        <tr class="unread">
                          <td class="inbox-small-cells">
                            <input type="checkbox" class="mail-checkbox">
                    ...
                    <div style="margin:10px 20px 0 0; text-align:right;">
                      <button type="button" class="btn btn-default" onClick="location.href='./notice_create.html'">글쓰기</button>
