...
<section>
	...
	<div class="contact-cont pb-3">
		...
		<div class="row mail-w3l-w3pvt-">
            ...
            <form role="form" action="/front/meeting/board/modify?meeting_num=${param.meeting_num}&free_board_num=${param.free_board_num}" method="post" enctype="multipart/form-data">
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
				...
				<div class="form-group">
					제목<input type="text" id="to" class="form-control" name='title' value='<c:out value="${board.title}"/>'>
				</div>
				<div class="form-group">
					 카테고리 &nbsp;
				...
				<div class="form-group">
					<textarea class="form-control" id="summernote" name="contents" maxlength="140" rows="7"><c:out value="${board.contents}"/></textarea>
				</div>
                <div class="form-group">
              ...
              <div style="float: right;">
              	<button type="submit" class="btn btn-primary" style="position: relative; right: 70px;">수정하기</button>
              </div>
              <div style="float: right; margin-right: 10px;">
             	 <button type="button" class="btn sm" style="position: relative; left: 100px;" ;onclick="history.back()">취소</button>
              </div>
          </form>
		  </div>
		</div>
