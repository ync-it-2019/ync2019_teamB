...
<section class="news py-5">
    ...
    <h5 style="margin : 20px;"><a href="./list">진행중인 이벤트</a> | <a href="#" style="color : #007bff">종료된 이벤트</a></h5>
    <hr>
		...
		<div class="row blog-grids">
			<c:forEach items="${eventEndList}" var="eventEnd">
      			<div class="col-lg-4 col-md-6 newsgrid1" style="margin-top:30px;">
        			<div onClick="location.href='/front/event/endGet?event_num=<c:out value="${eventEnd.event_num}" />'"><img src="/resources/img/1.jpg" alt="news image" class="img-fluid2" style="cursor:pointer"></div>
					<h4 style="cursor:pointer" class="mt-4" onClick="location.href='/front/event/endGet?event_num=<c:out value="${eventEnd.event_num}" />'"><c:out value="${eventEnd.title}" /></h4>
