                  ...
                  <div class="compose-mail">
                    <form role="form-horizontal" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" tabindex="1" id="to" class="form-control" value="행복한 소모임인, 즐거운 소모임 되기!">
                      </div>
                      <div class="compose-editor">
                        <textarea class="wysihtml5 form-control" rows="9">안녕하세요. 소모임 운영진 입니다. 저희 소모임이 새로운 모습으로 모임인 분들을 찾아 뵙게 되었습니다.
                                  </textarea>
                        <input type="file" class="default" value="notice.png">
                      </div>
                      <div class="center">
                        <button class="btn btn-primary btn-sm" onClick="location.href='./event_detail.html'"><i class="fa fa-check"></i> 완료</button>
                        <button class="btn btn-sm" onClick="location.href='./event__detail.html'"><i class="fa fa-times"></i> 취소</button>
                      </div>
                    </form>
                  </div>
                  <button class="btn btn-sm" onClick="location.href='./event_list.html'">목록</button>
                </div>
              </section>
            </div>
          </div>
