                  ...
                  <div class="compose-mail">
                    <form role="form-horizontal" method="post">
                      <div class="form-group">
                        ...
                        <div class="center">
                          <button class="btn btn-primary btn-sm" onClick="location.href='./notice_list.html'"><i class="fa fa-check"></i> 완료</button>
                          <button class="btn btn-sm" onClick="location.href='./notice_list.html'"><i class="fa fa-times"></i> 취소</button>
                        </div>
                    </form>
                  </div>
