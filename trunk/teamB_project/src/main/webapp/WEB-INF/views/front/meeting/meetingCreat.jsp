...
<section>
	<div class="container">
		<form id="articleForm" role="form" action="/article" method="post">
			<br style="clear: both">
			<h3 style="margin-bottom: 25px;">모임 만들기</h3>
			<div class="form-group">
				<input type="text" class="form-control" id="subject" name="subject" placeholder="모임 이름을 입력해주세요" required>
			</div>
			<div class="form-group">
			...
			<div class="input-group-css">
				<input type="text" class="form-control-appointment" id="subject" name="subject" placeholder="모임 주제를 선택해주세요(드롭다운으로 변경해야함)" required>
				<input type="text" class="form-control-appointment" id="subject" name="subject" placeholder="모임 활동지역을 선택해주세요" required>
			</div>
